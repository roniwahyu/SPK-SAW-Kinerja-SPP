...
<div class="tab-pane fade" id="outside">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="icon-table"></i> Form bobot_pm</h3>
            <div class="btn-group pull-right">
                <a href="#inside" data-toggle="tab" class="btn btn-success"><i class="icon-checkbox-partial"></i> Daftar Bobot_pm</a>
        ...
        <div class="panel-body">
            <div class="row clearfix">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 kelola" style="display:none">
                    ...
                    <?php echo form_open(base_url().'bobot_pm/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                                                                
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <input type="hidden" value='' id="id_bobot" name="id_bobot">
                            
                            <div class="form-group">
                                <?php echo form_label('selisih : ','selisih',array('class'=>'control-label')); ?>
                                <div class="controls">
                                <?php echo form_input('selisih','','id="selisih" class="form-control" placeholder="Enter selisih"'); ?>
                                </div>
                            </div>
