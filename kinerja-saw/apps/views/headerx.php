...
<header class="navbar navbar-inverse navbar-static-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="<?php echo site_url(); ?>" class="navbar-brand">Aplikasi Gudang</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url('produk'); ?>">Kelola Produk</a></li>
                        <li><a href="<?php echo site_url('jenis'); ?>">Kelola Jenis Produk</a></li>
                        <li><a href="<?php echo site_url('pesan'); ?>">Kelola Pesanan</a></li>
                        <li><a href="<?php echo site_url('pesan_detail'); ?>">Kelola Detail Pesanan</a></li>
                        <li><a href="<?php echo site_url('pelanggan'); ?>">Kelola Pelanggan</a></li>
                        <li><a href="<?php echo site_url('pengiriman'); ?>">Kelola Pengiriman</a></li>
                        <li><a href="<?php echo site_url('status'); ?>">Kelola Status</a></li>
                        <li><a href="<?php echo site_url('kurir'); ?>">Kelola Kurir</a></li>
                               </ul>
                </li>
