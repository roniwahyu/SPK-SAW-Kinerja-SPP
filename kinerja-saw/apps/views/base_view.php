...
<html lang="en">
    ...
    <body>
        ...
        <link rel="stylesheet" href="<?php echo assets_url('londinium/css/icons.css'); ?>">
        <link rel="stylesheet" href="<?php echo assets_url('css/bootstrap-cosmo.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo assets_url('css/rekomendasi.css'); ?>">
