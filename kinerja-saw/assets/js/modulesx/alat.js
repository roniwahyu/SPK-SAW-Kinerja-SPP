$(document).ready(function(){
        ...
        oTable=$('#datatables').dataTable({
            ...
            "responsive": true,
            "aoColumns": [
                { "sClass": "id_alat","sName": "id_alat","sWidth": "30px", "aTargets": [0] } ,
                { "sClass": "nama_alat", "sName": "nama_alat", "sWidth": "80px", "aTargets": [ 1 ] },
                { "sClass": "area_perlindungan", "sName": "area_perlindungan", "sWidth": "80px", "aTargets": [ 1 ] },
