$(document).ready(function(){
        ...
        oTable=$('#datatables').dataTable({
            ...
            "responsive": true,
            "aoColumns": [
                { "sClass": "id_nilai_resiko","sName": "id_nilai_resiko","sWidth": "30px", "aTargets": [0] } ,
                { "sClass": "id_alternatif", "sName": "id_alternatif", "sWidth": "80px", "aTargets": [ 1 ] },
                { "sClass": "id_kriteria", "sName": "id_kriteria", "sWidth": "80px", "aTargets": [ 1 ] },
                { "sClass": "id_resiko", "sName": "id_resiko", "sWidth": "80px", "aTargets": [ 1 ] },
                { "sClass": "nilai_resiko", "sName": "nilai_resiko", "sWidth": "80px", "aTargets": [ 1 ] },
